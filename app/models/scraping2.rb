...
# kouhos = ['Uzbekistan','Turkey','UnitedKingdomofGreatBritainandNorthernIreland','Netherlands','Belgium']

# kouhos = ['Australia','Fiji','NewZealand','Solomon Islands','PapuaNewGuinea']

# kouhos = ['Canada','Mexico','Argentina','Ecuador','Colombia','Chile','Paraguay','Brazil','Peru']

# kouhos = ['Uganda','Kenya','Algeria','Egypt','Tunisia','Morocco','Zimbabwe','SouthAfrica','Swaziland']

kouhos = ['France','Switzerland','Austria','Germany','Hungary','Poland','Italy','Spain','Portugal','Sweden']
